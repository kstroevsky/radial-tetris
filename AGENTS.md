...
- The phone controller is now intentionally buttonless and supersedes the capsule/rail artwork: the board itself owns tap-to-rotate-clockwise, tangential orbit, inward soft-drop, and inward-flick hard-drop gestures. Teach it only through the first-use over-board guide and the small timed help control; keep normal gameplay feedback invisible.
